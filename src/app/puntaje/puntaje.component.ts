      ...
      html: `
        <form id="editPuntajeForm">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="actitudes" name='actitudes'>
          </div>

          <div class="mb-3">
            <label for="puntualidad" class="form-label">Puntualidad</label>
            <input type="number" class="form-control" id="puntualidad" name='puntualidad'>
          </div>

          <div class="mb-3">
            <label for="calificacionLider" class="form-label">Calificacion Lider</label>
            <input type="number" class="form-control" id="calificacionLider" name='calificacionLider'>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="especifico1" name='especifico1'>
          </div>

          <div class="mb-3">
            <label for="especifico2" class="form-label">Especifico 2</label>
            <input type="number" class="form-control" id="especifico2" name='especifico2'>
          </div>

          <div class="mb-3">
            <label for="puntajeTotal" class="form-label">Puntaje Total</label>
            <input type="number" class="form-control" id="puntajeTotal" name='puntajeTotalx'>
          </div>
